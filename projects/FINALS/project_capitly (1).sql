CREATE DATABASE project_capitly;
USE project_capitly;
...
-- FOR AGGRESSIONS
SELECT MIN(csat_score) AS min_score, MAX(csat_score) AS max_score, ROUND(AVG(csat_score),1) AS avg_score FROM calls WHERE csat_score!=0; #Mysql added a to blank rows. But the min is 1.
